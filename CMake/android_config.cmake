...
macro(os_set_flags)
    ...
    set(CMAKE_C_FLAGS   "${CMAKE_C_FLAGS}   -fdiagnostics-color=always -O3 -mfpu=neon -UNDEBUG")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -fdiagnostics-color=always -O3 -mfpu=neon -UNDEBUG")
